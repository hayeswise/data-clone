...
(function (exports) {
     ...
     * @namespace
     */
    if (typeof exports.WISE !== "function") {
        exports.WISE = function () {};
    }
    var WISE = exports.WISE;
    /**
...
}((typeof window !== 'undefined' && Object.prototype.toString.call(window) === '[object Window]') ? window : exports)); //Assume window or Node.